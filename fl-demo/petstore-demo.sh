...
curl_commands=(
    ...
    "curl -s -k -X POST '${PETSTORE_URL}/pet' -H 'accept: application/json' -F 'file=@eicar.com.txt;type=text/plain' -F 'data={\"id\": 110, \"category\": {\"id\": 110, \"name\": \"Camel\"}, \"name\": \"FortiCamel\", \"photoUrls\": [\"photo.png\"], \"tags\": [ {\"id\": 113, \"name\": \"FortiCamel\"}], \"status\": \"sold\"}'"
